package toy.board.domain.article.service;
...
import toy.board.domain.article.entity.BoardArticleCount;
import toy.board.domain.article.repository.ArticleRepository;
import toy.board.domain.article.repository.BoardArticleCountRepository;
