package toy.board.domain.articleread.data;
...
public class DataInitializer {
    RestClient articleServiceClient = RestClient.create("http://localhost:8080");
    RestClient commentServiceClient = RestClient.create("http://localhost:8080");
    RestClient likeServiceClient = RestClient.create("http://localhost:8080");
    RestClient viewServiceClient = RestClient.create("http://localhost:8080");
